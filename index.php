                        ...
                        <ul class="slides">
                            <li>
                                ...
                                <div class="slider-caption visible-md visible-lg">
                                    ...
                                    <a href="#" class="slider-btn">Responsive Template</a>
                                </div>
                            </li>
                            <li>
                                <div class="overlay"></div>
                ...
                <div class="row">
				    ...
				    Consectetur quod at aperiam corporis totam. Nesciunt minima laborum sapiente totam facere unde est cum quia. Hic, suscipit, praesentium earum quod ea distinctio impedit ullam deserunt minus dolore quibusdam quis saepe aliquam doloribus voluptatibus eum excepturi.
                        ...
                        <ul class="contact-info">
                            <li>Phone: +2547-731-881</li>
                            <li>Email: <a href="mailto:info@company.com">kevinmactoo7576@gmail.com</a></li>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-xs-12 text-left">
                        <!--Copyright © 2084 Company Name | Design: <a href="http://www.templatemo.com">templatemo</a>-->
                    </div> <!-- /.text-center -->
